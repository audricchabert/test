...
/**
 * Mod�lisation d'une salle. Abstraite.
...
public abstract class Salle {
	...
	// Ajouter le "nombre" de fourmis � la salle.
	abstract public boolean ajouterFourmi(int nombre);
		
	// Supprimer une fourmi � la salle.
	abstract public boolean supprimerFourmi();
	
	// Supprimer le "nombre" de fourmis � la salle.
	...
	/**
	 * Setter
	 * @param nbCourantFourmi:Nombre de fourmi � mettre dans la salle.
	 */
