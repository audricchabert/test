...
/**
 * Cette classe instancie toutes les dépendances nécessaires pour le lancemenet d'un plateau indidivuel.
 * La classe effectue le lien entre l'IA et les éléments du plateau individuel 
...
public class PlateauIndividuel {
	...
	public PlateauIndividuel() {
		...
		// Evenement choisi aléatoirement
